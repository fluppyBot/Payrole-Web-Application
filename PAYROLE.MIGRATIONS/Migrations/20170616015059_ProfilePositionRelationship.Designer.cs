...
namespace PAYROLE.MIGRATIONS.Migrations
{
    ...
    [Migration("20170616015059_ProfilePositionRelationship")]
    partial class ProfilePositionRelationship
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PAYROLE.MODEL.Models.Profile", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PAYROLE.DATA.ApplicationUser", b =>
                {
                    b.HasOne("PAYROLE.MODEL.Models.Profile", "Profile")
                        .WithMany()
